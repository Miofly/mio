...
var _hm = document.createElement("script");
    ...
    //加载完hammer.js后开始执行
    _hm.onload = function() {
      var _ip = document.createElement("script");
      _ip.src = "http://pv.sohu.com/cityjson?ie=utf-8";
      var s_ip = document.getElementsByTagName("script")[1];
      s_ip.parentNode.insertBefore(_ip, s_ip);
      _ip.onload = function() {
        /*
         *
         * 获取ip参数的值;
