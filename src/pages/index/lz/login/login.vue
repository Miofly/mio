        ...
        <view class="bg-white center padding-xl border-radius width-ninety padding-top-xxl">
            ...
            <view class="margin-top-ten">
                ...
                <view style="border-bottom: 1px solid rgba(0, 0, 0, 0.3)" >
                    ...
                    <input v-model="password" :focus="false" :password=false placeholder="请输入密码" maxlength="8" confirm-type="完成"/>
                </view>
            </view>
            ...
            <view class="flex justify-between margin-top-xl">
                <router-link to="{name: 'lz_forget'}" class="text-blue">忘记密码</router-link>
                <router-link to="{name: 'lz_reg'}" class="text-blue">注册账号</router-link>
            </view>
