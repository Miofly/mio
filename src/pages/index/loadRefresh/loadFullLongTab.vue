			...
			<view class="full-height">
				...
				<scroll-view scroll-x style="position: fixed;left: 0" :style="{top: headerHeight + 'rpx'}">
					<view class="flex justify-around bg-white">
						...
						<!--tab栏右侧需要的内容-->
						<view v-if="rightCon">
							<image src="/static/images/lbVideo/paihangbang.png" style="width: 72rpx;height: 100rpx"></image>
						</view>
					</view>
				</scroll-view>
				<!--固定设置高度-->
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                leftCon: false, // 左侧展示内容
                rightCon: false, // 右侧展示内容
